...
from .util import get_primary_avatar
from .models import Avatar
from .settings import AVATAR_DEFAULT_URL, AVATAR_MAX_AVATARS_PER_USER
...
class AvatarUploadTests(TestCase):
    ...
    def testDefaultUrl(self):
        response = self.client.get (reverse ('avatar_render_primary', 
    ...
    def testThereCanBeOnlyOnePrimaryAvatar(self):
        for i in range (1, AVATAR_MAX_AVATARS_PER_USER):
