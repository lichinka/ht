...
@login_required
def add (request, extra_context=None,
         next_override=None,
         upload_form=UploadAvatarForm, 
         template_name='avatar/add.html',
         *args, **kwargs):
    """
    A view for adding an avatar to the current user's accounts.-
    """
...
def change (request, 
            ...
            *args, **kwargs):
    """
    Changes an avatar of the current user.-
    """
    if extra_context is None:
        extra_context = {}
    avatar, avatars = _get_avatars(request.user)
...
def delete (request, 
            extra_context=None, 
            next_override=None,
            template_name='avatar/delete.html',
            *args, **kwargs):
    """
    Deletes one or more avatars from the user's account.-
    """
    if extra_context is None:
        extra_context = {}
    avatar, avatars = _get_avatars(request.user)
