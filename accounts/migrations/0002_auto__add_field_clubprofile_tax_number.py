...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClubProfile.tax_number'
        db.add_column('accounts_clubprofile', 'tax_number', self.gf('django.db.models.fields.CharField')(default=u'* empty *', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClubProfile.tax_number'
        db.delete_column('accounts_clubprofile', 'tax_number')
    ...
    models = {
        'accounts.clubprofile': {
            ...
            'tax_number': ('django.db.models.fields.CharField', [], {'default': "u'* empty *'", 'max_length': '50'}),
