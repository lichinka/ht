...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('user_messages_message', (
            ...
            ('parent_msg', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='next_messages', null=True, to=orm['user_messages.Message'])),
        ...
        db.send_create_signal('user_messages', ['Message'])


    def backwards(self, orm):
        
        # Deleting model 'Message'
        db.delete_table('user_messages_message')
    ...
    models = {
        ...
        'user_messages.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_msg': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'next_messages'", 'null': 'True', 'to': "orm['user_messages.Message']"}),
