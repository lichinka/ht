...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_playerprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, blank=True)),
            ('level', self.gf('django.db.models.fields.CharField')(default='B', max_length=1)),
            ('male', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('right_handed', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('accounts', ['PlayerProfile'])

        # Adding model 'ClubProfile'
        db.create_table('accounts_clubprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, blank=True)),
        ...
        db.send_create_signal('accounts', ['ClubProfile'])


    def backwards(self, orm):
        
        # Deleting model 'PlayerProfile'
        db.delete_table('accounts_playerprofile')

        # Deleting model 'ClubProfile'
        db.delete_table('accounts_clubprofile')
